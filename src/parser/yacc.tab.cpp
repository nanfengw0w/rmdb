...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TRANSACTION = 36,               /* TRANSACTION  */
  YYSYMBOL_ISOLATION = 37,                 /* ISOLATION  */
  YYSYMBOL_LEVEL = 38,                     /* LEVEL  */
  YYSYMBOL_SNAPSHOT = 39,                  /* SNAPSHOT  */
  YYSYMBOL_SERIALIZABLE = 40,              /* SERIALIZABLE  */
  YYSYMBOL_LEQ = 41,                       /* LEQ  */
  YYSYMBOL_NEQ = 42,                       /* NEQ  */
  YYSYMBOL_GEQ = 43,                       /* GEQ  */
